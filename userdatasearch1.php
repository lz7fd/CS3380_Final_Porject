    ...
    <div class="ui-widget pageWidget">
        <table class="datatable">
            ...
            <?php
                ...
                $query = "SELECT UserData.ID, UserData.username, UserData.add_date, Orders.quantity, Orders.whatever FROM UserData INNER JOIN Orders ON UserData.ID = Orders.ID WHERE UserData.ID = $_POST[id]";
